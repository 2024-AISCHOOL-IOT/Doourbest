...
url = "https://stats.nba.com/stats/scheduleleaguev2int?GameSubType=&LeagueID=15&Season=2024-25&SeasonType=Regular%20Season"
headers = {
...
# 'broadcasters' 열 제거
schedule_df = schedule_df.drop(columns=['broadcasters'], errors='ignore')
